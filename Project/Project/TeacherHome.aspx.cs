...
namespace Project
{
    ...
    public partial class Teacherprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TextBoxSub.Visible = false;

            SqlConnection con = new SqlConnection("Data Source=AKSHAYCHANDRA;Initial Catalog=Project;Integrated Security=True");
            con.Open();
